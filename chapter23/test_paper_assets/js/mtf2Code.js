...
var activateSecond = function()
{
	...
	$('.r_clsOption').bind('touchstart click', function(e)
	{
		...
		$('#mtfGame').line(pointX.left+manageCenter, pointX.top+manageCenter, pointY.left+manageCenter, pointY.top+manageCenter, {color: lineColor, stroke: lineSize, class: className + " line"});
